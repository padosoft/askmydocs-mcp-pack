...
class McpHandshakeServiceTest extends TestCase
{
    ...
    public function test_refresh_runs_initialize_and_tools_list(): void
    {
        ...
        $this->assertSame(['server/discover', 'initialize', 'notifications/initialized', 'tools/list'], $methods);
        $this->assertSame('legacy', $payload['era']);
        $this->assertSame('2025-11-25', $payload['protocolVersion']);
    }
